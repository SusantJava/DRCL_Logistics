...
@ComponentScan(basePackages = "com.drcl") // <context:component-scan
public class AppConfig implements WebMvcConfigurer {
  ...
  //2.SessionFactory 
    ...
    public LocalSessionFactoryBean sfObj() {
	   ...
	   sf.setAnnotatedClasses(ShipmentType.class); //Model class names return sf;
	   return sf;
       }
